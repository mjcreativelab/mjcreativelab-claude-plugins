...
/mjc-claude-skill-tool:empirical-prompt-tuning [対象プロンプトの参照]
...
/mjc-claude-skill-tool:empirical-prompt-tuning packages/mjc-git-workflow/skills/smart-commit/SKILL.md

# empirical-prompt-tuning: 対象をフリーテキストで
/mjc-claude-skill-tool:empirical-prompt-tuning CLAUDE.md の「AI Agent Role Assignment」節
```
